...
NOT y -> i";
        ...
        {
            var day7 = new Day7();
            var a = day7.Calculate("a", TotalTestCase);
            Assert.Equal(3176, a);
        }
        ...
        {
            var day7 = new Day7();
            var a = day7.Calculate("a", TestCase2);
            Assert.Equal(14710, a);
        }

        private const string TotalTestCase = @"NOT dq -> dr
kg OR kf -> kh
ep OR eo -> eq
44430 -> b
NOT gs -> gt
...
he RSHIFT 2 -> hf";
        ...
        private const string TestCase2 = @"NOT dq -> dr
kg OR kf -> kh
ep OR eo -> eq
3176 -> b
NOT gs -> gt
