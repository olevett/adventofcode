...
namespace AdventOfCode.Tests
{
    public class Day6Tests
    {
        ...
        [InlineData(TestString, 543903)]
        public void TestProcessing(string input, int expectedOn)
        {
            var day6 = new Day6();
        ...
        [InlineData(TestString, 14687245)]
        ...
        private const string TestString = @"toggle 461,550 through 564,900
